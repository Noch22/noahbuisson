...
document.addEventListener("DOMContentLoaded", function() {
  ...
  document.addEventListener("mousemove", function(e) {
    ...
    const innerWidth = cursorInner.offsetWidth;
    const innerHeight = cursorInner.offsetHeight;
    const coefficient = 1;
...
burgers.forEach((item) => {
  item.addEventListener("click", function() {
    burgers.forEach((item2) => {
      item2.classList.toggle("opened");
    });
    menupage.classList.toggle("opened");
  });
});
const gradientBox = document.querySelector(".gradient");
window.matchMedia("(max-width: 768px)").matches ? " " : tl.to(gradientBox, {
  duration: 10,
  // Durée de l'animation en secondes
  background: "linear-gradient(135deg, #141414, #1E2C40)",
  // Nouveau dégradé
  ease: "power2.inOut",
  // Facilité d'animation (vous pouvez ajuster cela selon vos préférences)
  repeat: -1,
  // Répéter l'animation indéfiniment
  yoyo: true
  // Faire l'animation en sens inverse à la fin
});
document.addEventListener("DOMContentLoaded", function() {
...
/* harmony import */ var _js_header__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_js_header__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _js_cursor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./js/cursor */ "./src/js/cursor.js");
/* harmony import */ var _js_cursor__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_js_cursor__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _js_projet__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./js/projet */ "./src/js/projet.js");
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("d3124814adfc9d54a117")
/******/ 	})();
/******/ 	
